...
bras = raster('Geostatistical mixed effects model/Raster_10km.asc')
plot(bras)
...
dlay=read.csv("Geostatistical mixed effects model/FilteredTrack_Example.csv",header=T)
...
#stp=read.csv('Geostatistical mixed effects model/STG_Example.csv',header=T)
